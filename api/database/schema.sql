-- =============================================================
-- قاعدة بيانات: HoorKW - شركة حور لنقل العفش والأثاث
-- الإصدار: 1.0.0
...
('نقل الأثاث المنزلي', 'naql-athath-manzili', 'خدمة نقل الأثاث المنزلي الكاملة بأحدث السيارات المقفلة في جميع مناطق الكويت.', 'نقدم خدمة شاملة لنقل جميع قطع الأثاث المنزلي من غرف النوم والمجالس والمطابخ والأجهزة الكهربائية. نستخدم أحدث سيارات النقل المقفلة المجهزة خصيصاً لحماية الأثاث من الصدمات والغبار أثناء النقل. يتضمن الفريق نجارين محترفين لفك وتركيب جميع أنواع غرف النوم.', 'نقل أثاث منزلي الكويت | حور', 'خدمة نقل الأثاث المنزلي في الكويت بأمان واحترافية. سيارات مقفلة وعمالة مدربة وأسعار مناسبة.', 'active', 1),
...
اختر شركة نقل عفش معتمدة وذات سمعة جيدة في الكويت. تحقق من التقييمات والمراجعات على الإنترنت وتأكد من وجود تأمين على المنقولات.

ثالثاً: التغليف الجيد
التغليف هو أهم خطوة في عملية النقل. استخدم مواد تغليف عالية الجودة مثل كرتون مضلع سميك لحماية الأجهزة الكهربائية، ورول بابلز لحماية المزهريات والتحف.', 'نصائح نقل عفش الكويت - دليلك الشامل', 'اقرأ أفضل النصائح لنقل العفش بأمان في الكويت. خطوات عملية من خبراء شركة حور لنقل الأثاث.', 'published', NOW(), 245),
...
ثالثاً: التأمين والضمان
تأكد من أن الشركة توفر تأميناً على المنقولات في حال تعرضها لأي تلف أثناء النقل.', 'كيف تختار شركة نقل عفش موثوقة في الكويت', 'دليلك لاختيار أفضل شركة نقل أثاث في الكويت. معايير الاختيار والتحقق من الموثوقية والأسعار.', 'published', NOW(), 189),
...
('سارة العتيبي', 'ربة منزل - حولي', 'تجربة رائعة من البداية للنهاية. التواصل كان سريع والسعر مناسب جداً. غلفوا كل شيء بعناية خاصة الأواني والأجهزة. شكراً شركة حور!', 5, 'active'),
...
CREATE TABLE IF NOT EXISTS `settings` (
  `id`              INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `site_name`       VARCHAR(150) NOT NULL DEFAULT 'حور لنقل العفش',
...
VALUES
  ('حور لنقل العفش',
   ...
   'info@hoorkw.com',
   'دولة الكويت - العاصمة',
   'حور لنقل العفش | أفضل شركة نقل أثاث في الكويت',
   'شركة حور لنقل العفش والأثاث في الكويت. خدمات نقل وتغليف وتخزين الأثاث بأفضل الأسعار وأعلى معايير الأمان.');
