...
export default function ArticleDetailsClient({ article, related }: ArticleDetailsClientProps) {
          ...
          <Grid item xs={12} md={8}>
            <ScrollReveal direction="left">
              ...
              <Typography
                ...
                sx={{ lineHeight: 1.95, fontSize: '1.08rem', color: 'text.primary' }}
              />
            </ScrollReveal>
          </Grid>
