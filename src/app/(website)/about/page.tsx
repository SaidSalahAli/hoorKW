        ...
        <Grid container spacing={6} alignItems="center">
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.8, fontSize: '1.05rem' }}>
              نحرص على استخدام أفضل خامات التغليف العالمية من كرتون مضلع، رول بابلز، فوم، وبلاستيك استرتش لحماية الأثاث أثناء عمليات التحميل
              والنقل.
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
              ...
              <Grid item xs={12} sm={6} md={3} key={idx}>
                <Card sx={{ height: '100%', borderRadius: 3, p: 1, border: 'none', boxShadow: 'none', bgcolor: 'transparent' }}>
                  <CardContent sx={{ textAlign: 'center' }}>
                    <Box sx={{ color: 'primary.main', mb: 2, display: 'inline-flex' }}>{item.icon}</Box>
